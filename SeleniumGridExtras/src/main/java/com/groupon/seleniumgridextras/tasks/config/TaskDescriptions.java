...
public class TaskDescriptions {
    ...
    public static class Endpoints {
		...
		public static final String KILL_PORT = "/kill_port";
		...
		public static final String REBOOTAPPIUM = "/rebootappium";
        public static final String REBOOTPHONE = "/rebootphone";
        public static final String REBOOTEMULATOR = "/rebootemulator";
		...
		public static final String ENVIRONMENT_TASKS = "/environment";
        public static final String APPIUM_TASKS = "/appium";
    ...
    public static class Description {
		...
		public static final String KILL_PORT = "Kills a given port";
		...
		public static final String REBOOTAPPIUM = "Restart the appium node";
        public static final String REBOOTPHONE = "Restart the phone";
        public static final String REBOOTEMULATOR = "Restart the emulator";
        ...
        public static final String ENVIRONMENT_TASKS = "Set of commands to work with Environments";
        public static final String APPIUM_TASKS = "Set of commands to work with Appium Nodes";
    ...
    public static class UI {
        ...
        public static class ButtonText {
			...
			public static final String KILL_PORT = "Kill Port";
            public static final String MOVE_MOUSE = "Move mouse";
            public static final String NETSTAT = "netstat";
            public static final String REBOOT = "reboot";
			public static final String REBOOTAPPIUM = "reboot appium";
            public static final String REBOOTPHONE = "reboot phone";
            public static final String REBOOTEMULATOR = "reboot emulator";
            public static final String SCREENSHOT = "screenshot";
            public static final String SETUP = "setup";
			...
			public static final String ENVIRONMENT_TASKS = "Environment Tasks";
            public static final String APPIUM_TASKS = "Appium Tasks";
        }
